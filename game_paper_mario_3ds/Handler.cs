...
using System.Linq;
using Cetera.Font;
using game_pm_itm3ds.Properties;
using Kontract.Compression;
using Kontract.Interface;

namespace game_pm_itm3ds
{
    ...
    public class Handler : IGameHandler
    {
        ...
        public string Name { get; } = "Paper Mario: Sticker Star (item)";
        ...
        public IList<Bitmap> GeneratePreviews(TextEntry entry)
        {
            ...
            Bitmap backgroundImg = new Bitmap(Resources.previewbg, 396, 42);

            // gold FromArgb(218, 165, 32)
            baseFont.SetColor(Color.FromArgb(203, 58, 36));
