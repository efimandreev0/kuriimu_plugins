...
using System.Linq;
using Cetera.Font;
using game_splatoon_wiiu.Properties;
using Kontract.Compression;
using Kontract.Interface;

namespace game_splatoon_wiiu
{
    ...
    public class Handler : IGameHandler
    {
        ...
        public string Name { get; } = "Splatoon";
        ...
        public IList<Bitmap> GeneratePreviews(TextEntry entry)
        {
            ...
            Bitmap backgroundImg = new Bitmap(Resources.previewbg, 400, 100);
